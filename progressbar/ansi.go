...
// renderNoLock draws a single-line progress bar to pb.out (stderr by default).
...
func (pb *PBar) renderNoLock(count int) {
	...
	// Refresh columns (resize events can be missed/coalesced).
